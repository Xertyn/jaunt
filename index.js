			...
			default:
				...
				switch (p1) {
					case 'range':
						...
						if (_m.c.range < 0) {
							mod.command.message(`Range out of bounds, defaulted to ${_m.c.range = 35}m.`.clr('FF0202'));
						}
						else {
					...
					case 'distance':
						...
						if (_m.c.distance < 100 || _m.c.distance > 350) {
							mod.command.message(`Distance out of bounds, defaulted to ${_m.c.distance = 200}.`.clr('FF0202'));
						}
						else {
					...
					case 'cooldown':
						...
						if (_m.c.cooldown < 500) {
							mod.command.message(`Cooldown out of bounds, defaulted to ${_m.c.cooldown = 3500}ms.`.clr('FF0202'));
						}
						else {
